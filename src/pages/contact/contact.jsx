        ...
        <div className="space"></div>
            ...
            <div className="contact-info">
                 <div className="info-div">
                    ...
                    <div className="space"></div>
                    <h5><a href="tel:+919025309755" className="text-dark text-decoration-none">9025309755</a></h5>
                 </div>
                 <div className="info-div">
                 ...
                 <div className="info-div">
                    ...
                    <div className="space"></div>
                    <h5><a href="mailto:diyaneishms.21it@kongu.edu" className="text-dark text-decoration-none">diyaneishms.21it@kongu.edu</a></h5>
                 </div>
                 <div className="info-div">
                    <FaLocationDot size={50}/>
                    <h2 className="text-dark p-4">LOCATION</h2>
                    <div className="space"></div>
                    <h5>10/76,Kolinjikattur</h5>
                    <h5>Chinnanoor(PO),Sankari,Salem 637102</h5>
                 </div>
                </div>
